...
try {
    $stmt = $pdo->query("
        SELECT session_id, nombre_ciclista, fecha_inicio 
        FROM sesiones 
...
<head>
    ...
    <script>
        // Funci�n que se llamar� cuando la API de Google Maps est� lista
        function initGoogleMaps() {
            // La API est� cargada y disponible
            initMap();
        }

        // Funci�n que se llamar� si hay un error al cargar la API
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCFAxvX54P3lcyyNR62JdS7DJmcUiJRv3c&callback=initGoogleMaps&v=weekly" async defer onerror="handleGoogleMapsError()"></script>
</head>
<body>
    <nav class="navbar">
    ...
    <div class="container">
        <div class="session-selector">
            <h3><i class="fas fa-bicycle"></i> Seleccionar Sesi�n Activa</h3>
        ...
        <div id="realTimeData" class="real-time-container d-none">
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="data-card">
                        <h4><i class="fas fa-heartbeat"></i> Frecuencia Card�aca</h4>
            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    <div class="data-card">
                        <h4><i class="fas fa-map-marker-alt"></i> Ubicaci�n en Tiempo Real</h4>
                        <div id="map-error">
                            <i class="fas fa-exclamation-triangle"></i> 
                            No se pudo cargar el mapa. Por favor, verifica tu conexi�n a internet y recarga la p�gina.
                        </div>
                        <div id="map"></div>
                    </div>
                </div>
    ...
    <script>
        ...
        function initMap() {
            try {
                // Coordenadas iniciales (puedes ajustarlas seg�n tu ubicaci�n preferida)
                const initialPosition = { lat: 19.4326, lng: -99.1332 }; // Ciudad de M�xico como ejemplo
                map = new google.maps.Map(document.getElementById('map'), {
                    zoom: 15,
                    center: initialPosition,
                    mapTypeId: 'terrain', // Tipo de mapa m�s adecuado para ciclismo
                    styles: [
                        {
                            featureType: "poi",
                            elementType: "labels",
        ...
        function startRealTimeUpdates() {
            ...
            if (!sessionId) {
                alert('Por favor, seleccione una sesi�n');
                return;
            }
        ...
        function updateData() {
            ...
            fetch(`get_session_data.php?session_id=${currentSessionId}`)
